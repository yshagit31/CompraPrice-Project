...
//   const getSavings = () => Math.abs(product.price - product.price);
...
//   const source = isAmazon ? 'Amazon' : 'Flipkart';

//   return (
//     <div className="card shadow-sm border rounded-4 h-100 p-3">
//       <img src={product.image} className="card-img-top bg-light p-2 rounded" alt={product.title} />
//       <div className="card-body">
//         <span className="badge bg-secondary mb-2">{source}</span>
//         <h5 className="card-title">{product.title}</h5>
//         <p className="card-text fw-bold">{formatPrice(product.price)}</p>
//         <a href={product.url} target="_blank" rel="noopener noreferrer" className={`btn w-100 ${isAmazon ? 'btn-warning' : 'btn-primary'}`}>
//           View on {source}
//         </a>
//       </div>
//     </div>
  ...
  return (
    ...
    >
      ...
      <div className="card-body p-3">
        <span className="source-badge mb-2">{source}</span>
        <h5 className="card-title">{product.title}</h5>
        <p className="card-text fw-bold">{formatPrice(product.price)}</p>
        <a
          href={product.url}
